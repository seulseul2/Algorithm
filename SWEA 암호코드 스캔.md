...
- 문제 내 조건이 너무 많아서 쉽게 풀리지 않았다. 더불어 input 자료가 너무 방대해서 어느 부분에서 잘못됐는지 디버깅하기도 상당히 까다로웠던 문제였다.
- 간만에 유클리드 호제법 (최대공약수, 최소공배수)에 대해 복습했다.
- int -> str와 str -> int 작업을 계속 반복하며 익숙해질 수 있었다.